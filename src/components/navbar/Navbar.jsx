...
{/* 
                  ...
                  {user?.user?.email==="dhruv4258@gmail.com"?
                  <div className="flow-root">
                  ...
                  {user?
                    <div className="flow-root">
                    <a className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer"  onClick={logout} style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Logout
                    </a>
                  </div>:
                  <Link to={"/login"}>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  {user?.user?.email==="dhruv4258@gmail.com"? <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link>:""}
